...
/* --- Одна строка: название + чипсы --- */
.tech-stack__row {
  display: flex;
  align-items: center;
  gap: var(--spacing-lg);

  /* ↓ Если нужно визуально разделять строки — добавь padding-bottom и border-bottom */
}
...
.tech-stack__chips {
  ...
  gap: var(--spacing-sm);    /* ↓ Настрой расстояние между чипсами */
  flex: 1;
}
